...
public class ChatActivity2 extends AppCompatActivity {
    ...
    // local user and recipient
    private String currentUser = "mary";
    private String chatPartner = "bob";  // recipient name shown on top
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // show the recipient’s name on top
